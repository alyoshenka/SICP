...
(assert-result " 1105 is not prime " (miller-rabin-prime?  1105 10) #f) ; (Carmichael number)
(assert-result " 1729 is not prime " (miller-rabin-prime?  1729 10) #f) ; (Carmichael number)
(assert-result " 2465 is not prime " (miller-rabin-prime?  1465 10) #f) ; (Carmichael number)